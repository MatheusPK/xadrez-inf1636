...
public class ModelFacade {
	...
	public static int [][] movDisp(int x, int y, int vez) {
		...
		pecaClicked = p;
		System.out.printf("peca clicada x: %d, y: %d", pecaClicked.x, pecaClicked.y);
	...
	public static int movRealiza(int toX, int toY, int vez) {
		if (pecaClicked == null){
			System.out.println("pecaClicked (temporario) � nulo");
	...
	//retorna se posicao � um dos elementos do vetor de mov disp
    ...
    public static void realizaPromocao(int pecaNova) {
        ...
        if (peaoPromo == null) {
        	System.out.println("peaoPromo (temporario) � nulo");
			return;
        }
